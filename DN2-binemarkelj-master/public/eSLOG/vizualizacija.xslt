	...
	<xsl:template match="/IzdaniRacunEnostavni/Racun">
		...
		<html>
			...
			<body class="normal">				
				...
				<xsl:variable name="narocnik_drzava" select="concat('', $narocnik/NazivNaslovPodjetja/NazivDrzave)"/>
				...
				<table width="800px" align="center" border="0" cellpadding="0" cellspacing="0">
							...
							<table width="100%" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="35%" valign="top">
										<table width="100%" border="0" cellpadding="1" cellspacing="0">
											<tr>
												<td colspan="2" align="right" valign="top"><img alt="Logo" src="https://teaching.lavbic.net/cdn/OIS/eRacun.png"/></td>
											</tr>
											<tr>
												<td height="20px"/>
											</tr>
					...
					<tr>
						<td style="border-top: 1px solid gray; color: gray;" class="small" align="center">UL FRI vizualizacija E-SLOG računa, skladna s priročnikom ESLOG 1_6 verzije 2012/1_4</td>
					</tr>
				</table>
			</body>
		</html>
